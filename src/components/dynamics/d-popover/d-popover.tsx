...
export const DynamicPopover: React.FC<DynamicPopoverProps> = (props): React.ReactNode => {
  const { trigger, content, contentClassName, triggerClassName } = props;

  return (
    <Popover>
      <PopoverTrigger className={cn(triggerClassName, "")} asChild>{trigger}</PopoverTrigger>
      <PopoverContent
